...
adminRouter.delete('/delete/:username', auth_middleware_1.authenticateUser, (0, auth_middleware_1.roleBasedAccess)(['admin', 'Admin']), admin_controller_1.AdminController.deleteUserByUsername);
