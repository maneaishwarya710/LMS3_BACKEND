...
tutorRouter.get('/contentByCourseId/:id', auth_middleware_1.authenticateUser, (0, auth_middleware_1.roleBasedAccess)(['tutor']), tutor_controller_1.TutorController.getCourseContentsByCourseId);
